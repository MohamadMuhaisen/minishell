...
#    Updated: 2024/09/04 15:55:48 by mmuhaise         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell

SRCS = main utils/utils utils/heredoc utils/path utils/utils_extended utils/printing quotations/quotations quotations/expansion quotations/quotations_utils
